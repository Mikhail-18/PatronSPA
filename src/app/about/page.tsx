        ...
        <CardContent className="space-y-6">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="flex-1 space-y-4">
              <p>
                El <strong>React Router Explorer</strong> es un proyecto diseñado para mostrar una experiencia fluida de Aplicación de Página Única (SPA) dentro de un marco de trabajo robusto. Aunque el nombre rinde homenaje al clásico `react-router`, esta aplicación está construida sobre los potentes cimientos de Next.js y su App Router.
              </p>
              <p>
